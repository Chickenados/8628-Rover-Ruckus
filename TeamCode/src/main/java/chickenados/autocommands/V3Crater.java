...
@Autonomous(name = "V3 Crater")
public class V3Crater extends LinearOpMode{
                ...
                switch (currentState) {
                    ...
                    case TURN_TO_SCORE:
                        ...
                        if(goldState == RobotV1VisionAnalyzer.GoldState.UNKNOWN
                            ...
                            angleToMaintain = CENTER_MINERAL_ANGLE;
                    ...
                    case TURN_TO_DEPOT:
                        ...
                        robot.pidDrive.driveDistanceTank(0,135,2,event);
                    ...
                    case DRIVE_TO_CRATER:
                        ...
                        robot.pidDrive.driveDistanceTank(70,-45,2,event);
