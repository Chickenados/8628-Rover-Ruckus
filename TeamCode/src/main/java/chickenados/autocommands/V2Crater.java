...
@Autonomous(name = "V2Crater")
public class V2Crater extends LinearOpMode{
            ...
            if (sm.isReady()) {
                ...
                switch (currentState) {
                    ...
                    case DRIVE_FROM_GRABBER:
                        ...
                        robot.pidDrive.driveDistanceTank(5, 0, 1.5, event);
                    ...
                    case DRIVE_TO_MINERAL:
                        ...
                        robot.pidDrive.driveDistanceTank(20,angleToMaintain,4, event);
